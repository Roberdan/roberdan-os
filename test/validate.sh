...
# anything.
if bash test/test-bus-mutants.sh >/dev/null 2>&1; then ok "every load-bearing bus check has been seen to fail (45/45 mutants caught, 1 declared survivor)"; else err "test-bus-mutants — a mutant SURVIVED, see bash test/test-bus-mutants.sh"; fi
