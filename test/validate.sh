...
for _s in test-canon-guardrails test-factory-kb test-kb-views test-kb-board test-kb-done-gate test-kb-diet test-kb-queue \
          ...
          test-drift test-links test-privacy test-plan-coverage test-optional-skills; do
  _spawn "$_s"
done
unset _s
...
if _suite test-optional-skills; then ok "optional catalog and isolated packaging"; else _suite_out test-optional-skills; err "test-optional-skills failed"; fi
