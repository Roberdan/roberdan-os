...
| **Model selection** | Reviewed model capabilities, provider-specific resolution, explicit runtime preferences | [`skills/model-selection-policy/`](skills/model-selection-policy/skill.md) · [`bin/models.sh`](bin/models.sh) · [`bin/copilot-agent.sh`](bin/copilot-agent.sh) |
