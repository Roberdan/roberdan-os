...
| Linear-inspired interfaces | [`linear-ui`](skills/linear-ui/skill.md) + [verification checklist](skills/linear-ui/verification.md) | platform-aware design guidance: compact workspaces, themed menus, adaptive actions and whole-surface accessibility; preserves existing themes/palettes, complements Apple guidance, and is not a universal substitute for `design-review` |
