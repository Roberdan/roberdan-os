...
The most common way to look smart without being smart is **framework parading** — "now
I'll do a SWOT, then Cynefin, then OODA". This is **cargo-cult reasoning** (Feynman's
term): the form of reasoning without the substance. More frameworks ≠ smarter. Often the
opposite.

The correct flow:

1. **Diagnose first.** What's the question *really*? What kind of problem is it (clear?
...
new to the topic, play with the idea, admit uncertainty, find joy in understanding. Clarity
is a form of honesty. *"If you can't explain it simply, you don't understand it."*
