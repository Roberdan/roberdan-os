...
EOF
  ...
  # Matcher "Bash|Edit|Write" (not "*"): only these tools can change bus/repo state, and
  # every PostToolUse call costs ~0.55s — a Read/Glob/Grep/WebFetch turn pays nothing.
