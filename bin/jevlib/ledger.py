...
a stop. Prices are the documented 2026-09-20 values, not live account pricing.
"""
...
STATE_KEYS = ("version", "requests", "charged_nano_usd", "input_tokens", "output_tokens",
              "uncertain_requests", "reservation_exceeded", "cache")
TOTAL_MAX = 10**18
...
def config(area):
    ...
    core.require(type(value["approval"]) is str and 0 < len(value["approval"]) <= 1000
